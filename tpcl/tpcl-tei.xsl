        ...
        <section class="row">
            ...
            <article class="col-md-12"> 
                <div class="callout callout-primary">
                    <div class="p-2 bg-light border">Od: <xsl:apply-templates
                            select="//tei:correspAction[@type = 'sent']/tei:persName"/> iz:
                            <xsl:apply-templates
                            select="//tei:correspAction[@type = 'sent']/tei:placeName"/> poslano:
                            <xsl:apply-templates
                            select="//tei:correspAction[@type = 'sent']/tei:date/@when"/>
                    </div>
                    <div>Od: <xsl:apply-templates
                            select="//tei:correspAction[@type = 'received']/tei:persName"/> iz:
                            <xsl:apply-templates
                            select="//tei:correspAction[@type = 'received']/tei:placeName"/>
                        prejeto: <xsl:apply-templates

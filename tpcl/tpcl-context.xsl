                ...
                <li>
                    ...
                    <span class="results">
                        <a>
                            ...
                            <xsl:variable name="ovoj" select="substring(substring-after($title, '35_'), 1, string-length(substring-after($title, '_')) - string-length(substring-after(substring-after($title, '_'), '_')) - 1)"/>
